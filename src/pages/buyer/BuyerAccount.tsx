...
export function BuyerAccount() {
  ...
  return <div className="mx-auto max-w-4xl px-4 pb-6 lg:px-8">
      <header className="border-b border-sand-300 bg-white p-4 lg:rounded-card lg:border lg:shadow-card">
      ...
      <div className="mt-4 space-y-4 lg:grid lg:grid-cols-2 lg:gap-6 lg:space-y-0">
        ...
        <div className="space-y-4">
          <section aria-labelledby="wishlist">
